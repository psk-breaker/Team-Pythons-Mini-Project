...
Use data structures (lists, dictionaries) to store menu items and prices.

Implement user input validation and error handling.

Simulate a real‑world ordering workflow.
...
Basket Summary – View current selections before checkout.

Price Calculation – Automatically calculates totals.

Receipt Generation – Prints a final receipt with itemised costs.

Exit / Restart Options – Allows users to start a new order or quit.
